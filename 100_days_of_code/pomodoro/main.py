...
def reset_timer():
    ...
    title_label.config(text="Timer", font=(FONT_NAME, 30, "bold"), fg=GREEN)
...
title_label = Label(text="Timer", font=(FONT_NAME, 30, "bold"), highlightthickness=0, bg=YELLOW, fg=GREEN)
...
checkmarks_label = Label(font=(FONT_NAME, 24, "bold"), bg=YELLOW, fg=GREEN)
